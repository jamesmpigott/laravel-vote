<template>
    ...
    <div v-else-if="dataFetchErrors" class="mt-4 p-2.5 text-center rounded-lg border-red-500 border-2">
        {{ this.$trans.get("generic.poll-load-error") }}
    </div>
